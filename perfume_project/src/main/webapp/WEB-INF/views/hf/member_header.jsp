                        ...
                        <ul class="navbar-nav @@navbarClass">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu start">
                                    <li><a class="dropdown-item" href="../learn/learn_about.do">기본용어</a></li>
                                    <li><a class="dropdown-item" href="../learn/learn_about.do">향조</a></li>
                                    <li><a class="dropdown-item" href="../learn/learn_about.do">하우스</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../recommendation/3_test_questions.do">향수추천</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                                    커뮤니티
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu start">
                                    ...
                                    <li><a class="dropdown-item" href="../hyangsta/5_hyangsta_followPList.do?user_id=${sessionScope.user_id}">Following</a></li>
                                    <li><a class="dropdown-item" href="../hyangsta/5_hyangsta_userlist.do?user_id=${sessionScope.user_id}">My</a></li>
                                </ul>
                            </li>
                        </ul>
                        <!-- Navigation End -->
