            ...
            <div class="section">
                <div class="container">
                    <div class="row align-items-start">
                        ...
                        <!-- css = theme.css 파일 참고 -->
                        <div id = "myPage_header_reWriteMyInfo" class="mt-5 mb-5">
                            개인정보 수정
                        </div>
                        ...
                        <div id = "myPage_changeProfileWrapper">
                         ...
                         <!-- 프로필 사진 변경을 위한 div -->
		                   	<div id = "myPage_profileImgDiv" class="mb-10">
                          ...
                          <div class="m-auto" style="width:500px;">
                                ...
                                <div id = "myPage_inputSection" class="row gy-4" >
                                	<div class="col-12 col-md-6">
                                        <label for = "myPage_uploadProfileImg">프로필 사진 변경<span class="text-danger">* </span></label>
		                         		<input id ="myPage_uploadProfileImg" type="file" name = "file" class="form-control" accept = "image/*" style="margin-left:0px;">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="account_First_Name">
                                            ID *
                                        </label>
                                        <input class="form-control" id="user_id" type="text" placeholder="변경할 ID" value=${sessionScope.user_id} name = "user_id">
                                    ...
                                    <div id = "myPage_inputSection_checkPassword" class="col-12 col-md-6">
                                     ...
                                     <div id = "myPage_inputSection_changeNickname" class="col-12 col-md-6">
                                        ...
                                        <div id = "myPage_inputSection_changeNickname_inputDiv">
                                            <input class="form-control" name = "nickname" id="nickname" type="text" placeholder="바꿀 닉네임" value=${sessionScope.nickname} required="">
                            ...
                            <form method = "post" action ="memberDelete.do" style="width:500px;" class="m-auto">
                            	<div id = "deleteDiv">
